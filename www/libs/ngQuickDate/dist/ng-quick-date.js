  ...
  app.provider("ngQuickDateDefaults", function() {
    return {
      options: {
        ...
        nextLinkHtml: '下一步 &rarr;',
        prevLinkHtml: '&larr; 上一步',
          ...
          scope.toggleCalendar = debounce(function(show) {
            if (isFinite(show)) {
              return scope.calendarShown = show;
                ...
                var a = document.querySelector(".quickdate-popup");
                     a.style.width = window.outerWidth+"px";
